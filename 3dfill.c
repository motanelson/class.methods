...
//gcc faceviewer3d_sdl.c -o faceviewer3d.exe -lSDL2 -lSDL2_gfx -lm
typedef struct {
    float x, y, z;
} Point3D;
...
void draw(SDL_Renderer *renderer, float angle) {
    ...
    for (int i = 0; i < face_count; i++) {
        ...
        filledPolygonRGBA(renderer, px, py, 4, 0, 0, 0, 255); // face preta
    }
...
int main(int argc, char *argv[]) {
    ...
    SDL_Window *window = SDL_CreateWindow("Faces 3D", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
